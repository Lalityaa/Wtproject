...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 7470873515</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">we provide best rooms</p>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>We provide best room in the market with the affordable pricing.</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>We provide the best and 24hr service in the market.</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lalitya, Aryan, Annaya,Anuraag</h4>
							<span></span>
							<p></p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7470873515</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Jain Global Campus, Banglore</p>
...
<!-- /contact -->
			<div class="copy">
		        <p><a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
